	...
	if(pSet) 
	{
		...
		pEntity= geEntity_EntitySetGetNextEntity(pSet, pEntity)) 
		{
			...
			if(EffectC_IsStringNull(pSource->szEntityName))
				pSource->szEntityName = (char *)geEntity_GetNameString(pEntity);
...
int CNPC::SaveTo(FILE *SaveFD, bool type)
{
	...
	{
		NonPlayerCharacter *pTheEntity = (NonPlayerCharacter*)geEntity_GetUserData(pEntity);
		WRITEDATA(type, &pTheEntity->alive, sizeof(geBoolean), 1, SaveFD);
		WRITEDATA(type, &pTheEntity->active, sizeof(geBoolean), 1, SaveFD);
		WRITEDATA(type, &pTheEntity->bState, sizeof(geBoolean), 1, SaveFD);
		WRITEDATA(type, &pTheEntity->CallBack, sizeof(geBoolean), 1, SaveFD);
		WRITEDATA(type, &pTheEntity->Tick, sizeof(geFloat), 1, SaveFD);
		WRITEDATA(type, &pTheEntity->MaxNumber, sizeof(int), 1, SaveFD);
		if(pTheEntity->alive)
		{
			...
			WRITEDATA(type, &Pos, sizeof(geVec3d), 1, SaveFD);
			WRITEDATA(type, &Rotation, sizeof(geVec3d), 1, SaveFD);
			WRITEDATA(type, &DBot->Velocity, sizeof(geVec3d), 1, SaveFD);
			WRITEDATA(type, &DBot->Stopped, sizeof(geBoolean), 1, SaveFD);
			WRITEDATA(type, &DBot->LastStopped, sizeof(geBoolean), 1, SaveFD);
			WRITEDATA(type, DBot->Animation, sizeof(char), 128, SaveFD);
			WRITEDATA(type, DBot->LastAnimation, sizeof(char), 128, SaveFD);
			WRITEDATA(type, &DBot->Dir, sizeof(int), 1, SaveFD);
			WRITEDATA(type, &DBot->TgtPos, sizeof(geVec3d), 1, SaveFD);
			WRITEDATA(type, &DBot->MoveVec, sizeof(geVec3d), 1, SaveFD);
			WRITEDATA(type, &DBot->NextWeaponTime, sizeof(float), 1, SaveFD);
			WRITEDATA(type, &DBot->Rank, sizeof(int), 1, SaveFD);
			WRITEDATA(type, &DBot->Active, sizeof(bool), 1, SaveFD);
			WRITEDATA(type, &DBot->Dying, sizeof(bool), 1, SaveFD);
			WRITEDATA(type, &DBot->DyingTime, sizeof(float), 1, SaveFD);
			WRITEDATA(type, &DBot->Attacking, sizeof(bool), 1, SaveFD);
			WRITEDATA(type, &DBot->Wander, sizeof(bool), 1, SaveFD);
			int value = DBot->theInv->Value(DBot->Attribute);
			WRITEDATA(type, &value, sizeof(int), 1, SaveFD);
		}
...
int CNPC::RestoreFrom(FILE *RestoreFD, bool type)
{
	...
	{
		NonPlayerCharacter *pTheEntity = (NonPlayerCharacter*)geEntity_GetUserData(pEntity);
		READDATA(type, &pTheEntity->alive, sizeof(geBoolean), 1, RestoreFD);
		READDATA(type, &pTheEntity->active, sizeof(geBoolean), 1, RestoreFD);
		READDATA(type, &pTheEntity->bState, sizeof(geBoolean), 1, RestoreFD);
		READDATA(type, &pTheEntity->CallBack, sizeof(geBoolean), 1, RestoreFD);
		READDATA(type, &pTheEntity->Tick, sizeof(geFloat), 1, RestoreFD);
		READDATA(type, &pTheEntity->MaxNumber, sizeof(int), 1, RestoreFD);
		if(pTheEntity->alive)
		{
			geVec3d Pos, Rotation;
			Spawn(pTheEntity);
			Bot_Var *DBot = (Bot_Var *)pTheEntity->DBot;
			READDATA(type, &Pos, sizeof(geVec3d), 1, RestoreFD);
			READDATA(type, &Rotation, sizeof(geVec3d), 1, RestoreFD);
			CCD->ActorManager()->Position(DBot->Actor, Pos);
			CCD->ActorManager()->Rotate(DBot->Actor, Rotation);
			READDATA(type, &DBot->Velocity, sizeof(geVec3d), 1, RestoreFD);
			READDATA(type, &DBot->Stopped, sizeof(geBoolean), 1, RestoreFD);
			READDATA(type, &DBot->LastStopped, sizeof(geBoolean), 1, RestoreFD);
			READDATA(type, DBot->Animation, sizeof(char), 128, RestoreFD);
			CCD->ActorManager()->SetMotion(DBot->Actor, DBot->Animation);
			READDATA(type, DBot->LastAnimation, sizeof(char), 128, RestoreFD);
			READDATA(type, &DBot->Dir, sizeof(int), 1, RestoreFD);
			READDATA(type, &DBot->TgtPos, sizeof(geVec3d), 1, RestoreFD);
			READDATA(type, &DBot->MoveVec, sizeof(geVec3d), 1, RestoreFD);
			READDATA(type, &DBot->NextWeaponTime, sizeof(float), 1, RestoreFD);
			READDATA(type, &DBot->Rank, sizeof(int), 1, RestoreFD);
			READDATA(type, &DBot->Active, sizeof(bool), 1, RestoreFD);
			READDATA(type, &DBot->Dying, sizeof(bool), 1, RestoreFD);
			READDATA(type, &DBot->DyingTime, sizeof(float), 1, RestoreFD);
			READDATA(type, &DBot->Attacking, sizeof(bool), 1, RestoreFD);
			READDATA(type, &DBot->Wander, sizeof(bool), 1, RestoreFD);
			int value;
