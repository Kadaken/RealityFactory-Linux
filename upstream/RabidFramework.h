...
// Platform declarations are isolated behind the native compatibility boundary.
...
#include "LegacyNPCEntityDataTypes.h"	// Recovered 0.68A NPC map declarations.
