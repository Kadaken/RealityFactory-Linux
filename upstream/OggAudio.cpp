...
OggAudio::~OggAudio() { Delete(); }
int OggAudio::Load(const char *) { return RGF_FAILURE; }
int OggAudio::Play(bool) { return RGF_FAILURE; }
int OggAudio::Stop() { m_fActive = false; return RGF_SUCCESS; }
int OggAudio::Pause() { return RGF_SUCCESS; }
int OggAudio::Delete() { m_fActive = false; return RGF_SUCCESS; }
int OggAudio::Rewind() { return RGF_FAILURE; }
bool OggAudio::IsPlaying() { return false; }
int OggAudio::SetVolume(int) { return RGF_SUCCESS; }
DWORD OggAudio::GetMaxWriteSize() { return 0; }
int OggAudio::PumpWave(int) { return RGF_FAILURE; }
void CALLBACK OggAudio::TimerFunction(UINT, UINT, DWORD_PTR, DWORD_PTR, DWORD_PTR) {}
